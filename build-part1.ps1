...
==================================================
-->
<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>About | brpartsandcraftscoza </title><meta name="description" content="Artist biography and statement."><link rel="stylesheet" href="css/style.css"><link rel="stylesheet" href="css/mobile.css"></head><body><header class="site-header"><nav class="site-nav"><a class="brand" href="index.html">brpartsandcraftscoza</a><button class="nav-toggle" data-nav-toggle><span></span><span></span><span></span></button><div class="nav-links" data-nav-links><a href="index.html">Home</a><a href="gallery.html">Gallery</a><a href="about.html">About</a><a href="contact.html">Contact</a></div></nav></header><main class="page narrow reveal"><p class="eyebrow">About</p><h1>brpartsandcraftscoza makes atmospheric works about architecture, memory, and emotional weather.</h1><p>The paintings begin as observations from walks, train windows, studio notes, and small acts of looking. Their finished surfaces balance clarity and erasure.</p><p>Each work is built slowly through staining, drawing, scraping, and repainting. The process leaves visible evidence of time, allowing the final image to feel found rather than declared.</p><h2>Selected Exhibitions</h2><p><strong>2026</strong> Threshold Light, Northline Gallery</p><p><strong>2025</strong> Soft Architecture,  Room Project</p><p><strong>2024</strong> Weather Inside, Independent Works Fair</p></main><script src="js/menu.js"></script><script src="js/main.js"></script></body></html>
'@
...
==================================================
-->
<!doctype html><html lang="en"><head><meta charset="utf-8"><title>Not Found | brpartsandcraftscoza </title><link rel="stylesheet" href="css/style.css"></head><body><main class="page narrow"><p class="eyebrow">404</p><h1>This page is not in the archive.</h1><a class="button dark" href="gallery.html">Return to Gallery</a></main></body></html>
'@
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 630"><rect width="1200" height="630" fill="#f6f2ec"/><rect x="90" y="80" width="360" height="470" fill="#d8c4b2"/><rect x="410" y="120" width="300" height="390" fill="#586b70"/><text x="760" y="280" font-family="Georgia" font-size="74" fill="#111">brpartsandcraftscoza</text><text x="764" y="340" font-family="Arial" font-size="26" fill="#8d5d45">Contemporary Artist Portfolio</text></svg>
'@
